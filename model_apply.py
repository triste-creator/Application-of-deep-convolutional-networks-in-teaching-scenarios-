...
emotion_labels = {0: 'angry', 1: 'disgust', 2: 'fear', 3: 'happy', 4: 'sad', 5: 'suprise', 6: 'neutral'}
...
# video_capture = cv2.VideoCapture("D://教学场景视频//摄像3.mp4)
font = cv2.FONT_HERSHEY_SIMPLEX
cv2.startWindowThread()
cv2.namedWindow('Face_recognition_windows')
...
while True:
    ...
    try:
        # 将图片从内存中显示到屏幕上
        cv2.imshow('Face_recognition_windows', frame)
    except:
        continue
